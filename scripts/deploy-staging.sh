...
cd /home/hauke/packages/mtg/frontend && yarn install --production=false && rm -rf /home/hauke/packages/mtg/frontend/build/* && ./node_modules/.bin/react-scripts --max_old_space_size=4096 build
